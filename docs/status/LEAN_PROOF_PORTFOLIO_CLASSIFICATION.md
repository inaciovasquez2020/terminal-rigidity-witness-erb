...
Witness/documentation artifact. Not a theorem-proof repository.
...
`terminal-rigidity-witness-erb` is infrastructure/documentation, not a theorem-proof repository.
